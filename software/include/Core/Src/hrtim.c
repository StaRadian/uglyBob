...
void MX_HRTIM1_Init(void)
{
  ...
  pADCTriggerCfg.Trigger = HRTIM_ADCTRIGGEREVENT579_TIMERC_CMP3;
  ...
  pADCTriggerCfg.Trigger = HRTIM_ADCTRIGGEREVENT579_TIMERD_CMP3;
